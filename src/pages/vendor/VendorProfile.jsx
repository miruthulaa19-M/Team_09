                ...
                <div className="vp-profile-fields">
                  {FIELDS.map(({ key, label }) => (
                    <div className="vp-pf-row" key={key}>
                      <span className="vp-pf-label">{label}</span>
                      {editing ? (
                        <input
                          className="vp-field input"
                          style={{ padding:"10px 13px", border:"1px solid #E5E7EB", borderRadius:"10px", fontFamily:"inherit", fontSize:"14px", background:"#fafaf8", outline:"none" }}
                          value={draft[key] || ""}
